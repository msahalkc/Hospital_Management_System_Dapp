...
contract Body_Examine is ERC20 {
...
system sys;
      ...
      /**
     * @dev Create the Token by Passing the Name and Symbol to the ERC20 Constructor
     */
      constructor() ERC20("MedicalCoin","MEDC") public {
    ...
    */
     ...
     function namedecl() public view  returns (string memory) {
         //calling the Built-in function in ERC20
        return name();
    }
